...
# Title: If Else
# Generated: Tue Apr  2 02:24:02 2019
##################################################
...
class if_else(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, freq, ampl, 0)
        self.GooglePubSub_google_subscriber_py_b_0 = GooglePubSub.google_subscriber_py_b("elen-e6889", "gnuradio")
        self.GooglePubSub_google_publisher_py_b_0 = GooglePubSub.google_publisher_py_b("elen-e6889", "gnuradio")

        ##################################################
        # Connections
        ##################################################
        self.connect((self.GooglePubSub_google_subscriber_py_b_0, 0), (self.blocks_char_to_float_0, 0))
        ...
        self.connect((self.blocks_float_to_char_0, 0), (self.GooglePubSub_google_publisher_py_b_0, 0))
        self.connect((self.blocks_throttle_0_0, 0), (self.blocks_float_to_char_0, 0))
