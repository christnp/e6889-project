...
# Generated: Thu May 16 21:52:31 2019
##################################################
...
class rf_scanner_pubsub(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.center_freq = center_freq = 476.36250e6

        ##################################################
        # Blocks
        ##################################################
        self._center_freq_range = Range(470e6, 490e6, 0.0001e6, 476.36250e6, 200)
        self._center_freq_win = RangeWidget(self._center_freq_range, self.set_center_freq, 'precinct26', "counter_slider", float)
        ...
        self.qtgui_vector_sink_f_0 = qtgui.vector_sink_f(
            fft_size,
            (center_freq-samp_rate/2)/1.0e6,
            (samp_rate/fft_size)/1.0e6,
            "Frequency (MHz)",
            "Power (dB)",
            "",
            1 # Number of inputs
