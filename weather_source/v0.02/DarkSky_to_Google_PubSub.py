...
Final Project
    ...
    "currently":
     ...
     Version: DarkSky_to-Google_PubSub v0.02
...
while True:
    ...
    time_attr = str(data_obj["currently"]["time"])  # time from DarkSky API
    ...
    # publish a message
    dt_index = datetime.datetime.utcfromtimestamp(int(time_attr))
